...
picture { text { caption = "Twee symbolen verschijnen links en rechts van het kruis in het midden van het scherm. Kies één van de twee symbolen door een klik op het toetsenbord. Het rechter symbool kiest u door 2 in te toetsen, voor het linker symbool toetst u 1."; max_text_width = 1100; text_align = align_left; } t_Instructions2a; x = 0; y = 200; 
			 bitmap {filename = "keyboard2.jpg"; preload = true; scale_factor = 1;} b_Keyb; x = 0; y = -150;
			 bitmap {filename = "Stim11A.bmp"; preload = true; scale_factor = 0.8;} b_sym1; x = -150; y = 75;
			 bitmap {filename = "fix_cross.jpg"; preload = true; scale_factor = 0.25;} b_fix; x = 0; y = 75;
			 bitmap {filename = "Stim11B.bmp"; preload = true; scale_factor = 0.8;} b_sym2; x = 150; y = 75;
...
Dat betekent dat u opnieuw een scherm te zien krijgt met korte instructies. Op het moment dat u één van de 4 knoppen indrukt start de taak met enige vertraging."; max_text_width = 1100; text_align = align_left; } t_Instructions12a; x = 0; y = 150; 
			 bitmap {filename = "buttonbox.jpg"; preload = true; scale_factor = 0.5;} b_buttonbox; x = 0; y = 220;
			 text t_Instructions1b; x = 0; y = -350;
			 } p_Instructions12;
