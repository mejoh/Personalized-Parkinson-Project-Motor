...
for m in partial brady cogcom; do
	...
	fslmaths $wd/${m}_clincorr_bg_mask -add $wd/${m}_clincorr_bg_mask_flip -bin $wd/bi_${m}_clincorr_bg_mask
...
fslmaths $outdir/bi_brady_clincorr_bg_mask_cropped.nii -add $outdir/bi_cogcom_clincorr_bg_mask_cropped.nii -bin -dilF $outdir/bi_full_clincorr_bg_mask_cropped
