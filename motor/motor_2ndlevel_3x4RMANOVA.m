...
Inputs = cell(15,1);
if ~exclude_outliers 
    Inputs{1,1} = {fullfile(ANALYSESDir, GroupFolder, 'Imputed_Subtypes_x_ExtInt2Int3Catch_Exclude-sub-POMU86B947749A70E997')};
else
    Inputs{1,1} = {fullfile(ANALYSESDir, GroupFolder, 'Imputed_Subtypes_x_ExtInt2Int3Catch_NoOutliers_Exclude-sub-POMU86B947749A70E997')};
end
