...
% matlabbatch{3}.spm.stats.fmri_spec.mask = {'/project/3024006.02/templates/spm/mask_ICV.nii,1'};
% matlabbatch{3}.spm.stats.fmri_spec.mask = {'/project/3024006.02/templates/spm/mask_ICV_resampled.nii,1'};
% matlabbatch{3}.spm.stats.fmri_spec.mask = {'/project/3024006.02/templates/template_50HC50PD/ANTs_template_long/T_template0_mask_SPM.nii,1'};
