...
# ~/scripts/Personalized-Parkinson-Project-Motor/motor/Longitudinal/fsl_extract_loop.sh
...
# SESSION=(delta ba fu)
# ANALYSIS=(clincorr_all clincorr_brady clincorr_moca)
CONS=(con_0007 con_0010)
SESSION=(delta ba fu)
...
# Group comparisons
ANALYSIS=(unpaired_ttest_unmatched unpaired_ttest_matched)
for C in ${CONS[@]}; do
	DATADIR=${ANALYSISDIR}/data/${C}
	CONDIR=${ANALYSISDIR}/stats/${C}
	OUTDIR=${CONDIR}/vals
