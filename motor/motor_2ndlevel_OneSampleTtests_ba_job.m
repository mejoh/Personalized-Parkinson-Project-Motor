...
matlabbatch{1}.spm.stats.factorial_design.cov(4).c = '<UNDEFINED>';       % FD is correlated with BA severity. We trust that motion has been adequately corrected for. So dont include.
