...
% matlabbatch{1}.spm.stats.factorial_design.cov(5).c = '<UNDEFINED>';       % Might be too highly correlated with baseline severity
% matlabbatch{1}.spm.stats.factorial_design.cov(5).cname = 'EstDisDurYears';
