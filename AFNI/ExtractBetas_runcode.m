dir = {'/project/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/ROI/3dttest++';
    '/project/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/ROI/3dttest++_severity'};
con = {'con_0010' 'con_0012' 'con_0013'};
for d = 1:numel(dir)
    for c = 1:numel(con)
...
con = {'con_combined_Group2_x_TimepointNr2_x_Type3_Z_TimeGroup';
    'con_combined_Group2_x_TimepointNr2_x_Type3_Z_TimeGroupType2gt1';
    'con_combined_Group2_x_TimepointNr2_x_Type3_Z_TimeGroupType3gt1'};
for c = 1:numel(con)
