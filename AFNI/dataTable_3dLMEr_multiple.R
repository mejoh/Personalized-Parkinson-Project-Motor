...
c1 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0001_disease_dataTable.txt') %>%
  mutate(trial_type = '1c')
c2 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0002_disease_dataTable.txt') %>%
  mutate(trial_type = '2c')
c3 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0003_disease_dataTable.txt') %>%
  mutate(trial_type = '3c')
c2n3 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0005_disease_dataTable.txt') %>%
...
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_dataTable.txt'
write_tsv(c123, OutputName)

c123.c <- full_join(c1,c2n3) %>%
    arrange(Subj, TimepointNr, trial_type) %>% relocate(Subj, Group, trial_type)
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_dataTable2.txt'
...
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_HCvsMMP_dataTable.txt'
write_tsv(tmp, OutputName)
tmp <- c123 %>%
    filter(Subtype1 == '0_Healthy' | Subtype1 == '2_Intermediate') %>%
    mutate(Subtype1 = if_else(Subtype1=='0_Healthy','G1','G2'))
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_HCvsIM_dataTable.txt'
write_tsv(tmp, OutputName)
tmp <- c123 %>%
    filter(Subtype1 == '0_Healthy' | Subtype1 == '3_Diffuse-Malignant') %>%
    mutate(Subtype1 = if_else(Subtype1=='0_Healthy','G1','G2'))
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_HCvsDM_dataTable.txt'
write_tsv(tmp, OutputName)
...
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_MMPvsIM_dataTable.txt'
write_tsv(tmp, OutputName)
tmp <- c123 %>%
    filter(Subtype1 == '1_Mild-Motor' | Subtype1 == '3_Diffuse-Malignant') %>%
    mutate(Subtype1 = if_else(Subtype1=='1_Mild-Motor','G1','G2'))
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_MMPvsDM_dataTable.txt'
write_tsv(tmp, OutputName)
tmp <- c123 %>%
    filter(Subtype1 == '2_Intermediate' | Subtype1 == '3_Diffuse-Malignant') %>%
    mutate(Subtype1 = if_else(Subtype1=='2_Intermediate','G1','G2'))
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_disease_IMvsDM_dataTable.txt'
write_tsv(tmp, OutputName)

# Assemble combined tables for associations with clinical score
c1 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0001_severity_dataTable.txt') %>%
  mutate(trial_type = '1c')
c2 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0002_severity_dataTable.txt') %>%
  mutate(trial_type = '2c')
c3 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0003_severity_dataTable.txt') %>%
  mutate(trial_type = '3c')
c2n3 <- read_tsv('P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_0005_severity_dataTable.txt') %>%
  mutate(trial_type = '23c')

c12 <- full_join(c1,c2)
c123 <- full_join(c12,c3) %>%
  arrange(Subj, TimepointNr, trial_type) %>% relocate(Subj, TimepointNr, trial_type)
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_severity_dataTable.txt'
write_tsv(c123, OutputName)

c123 <- full_join(c1,c2n3) %>%
  arrange(Subj, TimepointNr, trial_type) %>% relocate(Subj, TimepointNr, trial_type)
OutputName <- 'P:/3024006.02/Analyses/DurAvg_ReAROMA_PMOD_TimeDer_Trem/Group/Longitudinal/AFNI/con_combined_severity_dataTable2.txt'
write_tsv(c123, OutputName)
