...
matlabbatch{1}.spm.stats.factorial_design.cov(3).cname = 'RespHandIsDom';
...
matlabbatch{1}.spm.stats.factorial_design.cov(4).cname = 'NpsEducYears';
...
matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'Hc';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [1 0];
matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'Pd';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [0 1];
matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = '-Hc';
matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [-1 0];
matlabbatch{3}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{8}.tcon.name = '-Pd';
matlabbatch{3}.spm.stats.con.consess{8}.tcon.weights = [0 -1];
...
matlabbatch{4}.spm.tools.tfce_estimate.conspec.contrasts = [2 5 6];
