...
% substrings = {'TremorLog', 'framewise_displacement', 'std_dvars', 'trans_', 'rot_',...
%     'a_comp_cor_01', 'a_comp_cor_02', 'a_comp_cor_03', 'a_comp_cor_04', 'a_comp_cor_05',...
%     'a_comp_cor_06', 'a_comp_cor_07', 'a_comp_cor_08', 'aroma2_', 'cosine'};
substrings = {'framewise_displacement', 'std_dvars', 'trans_', 'rot_', 't_comp_cor',...
    'a_comp_cor_00', 'a_comp_cor_01', 'a_comp_cor_02', 'a_comp_cor_03', 'a_comp_cor_04', 'a_comp_cor_05',...
    'a_comp_cor_06', 'a_comp_cor_07', 'aroma2_', 'global_signal', 'cosine', 'non_steady_state'};
