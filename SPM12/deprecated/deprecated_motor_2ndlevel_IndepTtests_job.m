...
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Hc < Pd';
...
matlabbatch{4}.spm.tools.tfce_estimate.mask = '<UNDEFINED>';
matlabbatch{4}.spm.tools.tfce_estimate.conspec.titlestr = '';
matlabbatch{4}.spm.tools.tfce_estimate.conspec.contrasts = [2 3];
