...
% Reference: TBA
%-----------------------------------------------------------------------
% EXAMPLE VOI DEFINITIONS
% 1. SPM contrast defines activation of interest. A sphere is set to
% capture that activation at a certain set of coordinates. A smaller sphere
% is then created within the larger one. This smaller sphere is mobile, and
% moves to where the peak activation is. The final mask is defined as the
% intersection between the thresholded contrast activation and the smaller
% sphere. Note that thresholding of the contrast image may leave no voxels
% left. If this happens, the subject will not have a mask or timeseries for
% the region of interest that is affected
% matlabbatch{1}.spm.util.voi.spmmat = '<UNIDENTIFIED>';
% matlabbatch{1}.spm.util.voi.adjust = 1;
% matlabbatch{1}.spm.util.voi.session = 1;
% matlabbatch{1}.spm.util.voi.name = 'REGION';
...
% 2. Same as 1, except that we use a mask created from the coordinates
% of the sphere above.
% matlabbatch{1}.spm.util.voi.spmmat = '<UNIDENTIFIED>';
% matlabbatch{1}.spm.util.voi.adjust = 1;
% matlabbatch{1}.spm.util.voi.session = 1;
...
% 3. This version creates a sphere at coordinates and extracts a
% timeseries. This version is completely agnostic to underlying activation,
% contrasts etc, and will always yield a timeseries.
% matlabbatch{1}.spm.util.voi.spmmat = '<UNIDENTIFIED>';
% matlabbatch{1}.spm.util.voi.adjust = 1;
% matlabbatch{1}.spm.util.voi.session = 1;
% matlabbatch{1}.spm.util.voi.name = 'REGION';
...
% matlabbatch{6}.spm.util.voi.roi{3}.sphere.radius = 8;
...
% matlabbatch{7}.spm.util.voi.roi{3}.sphere.radius = 8;
...
% matlabbatch{8}.spm.util.voi.roi{3}.sphere.radius = 8;
...
% matlabbatch{9}.spm.util.voi.roi{1}.spm.contrast = 1;
...
% matlabbatch{9}.spm.util.voi.roi{3}.sphere.radius = 8;
...
% matlabbatch{10}.spm.util.voi.roi{1}.spm.contrast = 1;
...
% matlabbatch{10}.spm.util.voi.roi{3}.sphere.radius = 8;
