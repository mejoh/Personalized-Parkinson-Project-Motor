...
generate_castor_csv <- function(bidsdir){
        ...
        CalculateDiseaseProgression <- function(dataframe){
                ...
                dataframe <- dataframe %>%
                        mutate(Up3OfTotal.1YearDelta = NA,
                               ...
                               Up3OfAppendicularSum.1YearDelta = NA,
                               Up3OnAppendicularSum.1YearDelta = NA,
                               Up3OfAppendicularSum.1YearROC = NA,
                               Up3OnAppendicularSum.1YearROC = NA,
                               ...
                               Up3OfCompositeTremorSum.2YearDelta = NA,
                               Up3OnCompositeTremorSum.2YearDelta = NA,
                               Up3OfCompositeTremorSum.2YearROC = NA,
                               Up3OnCompositeTremorSum.2YearROC = NA,
                               ...
                               Up3OfAppendicularSum.2YearDelta = NA,
                               Up3OnAppendicularSum.2YearDelta = NA,
                               Up3OfAppendicularSum.2YearROC = NA,
                               Up3OnAppendicularSum.2YearROC = NA,
                ...
                for(n in 1:nrow(dataframe)){
                        if(dataframe$Timepoint[n] == 'ses-POMVisit2' && dataframe$Timepoint[n-1] == 'ses-POMVisit1'){
                                ...
                                dataframe$Up3OfAppendicularSum.1YearDelta[(n-1):n] <- dataframe$Up3OfAppendicularSum[n] - dataframe$Up3OfAppendicularSum[n-1]
                                dataframe$Up3OnAppendicularSum.1YearDelta[(n-1):n] <- dataframe$Up3OnAppendicularSum[n] - dataframe$Up3OnAppendicularSum[n-1]
                                dataframe$Up3OfAppendicularSum.1YearROC[(n-1):n] <- elble.change(dataframe$Up3OfAppendicularSum[n-1], dataframe$Up3OfAppendicularSum[n], length(list.AppendicularOff), alpha = 0.5/length(list.AppendicularOff))
                                dataframe$Up3OnAppendicularSum.1YearROC[(n-1):n] <- elble.change(dataframe$Up3OnAppendicularSum[n-1], dataframe$Up3OnAppendicularSum[n], length(list.AppendicularOn), alpha = 0.5/length(list.AppendicularOn))
                                ...
                                dataframe$Up3OfCompositeTremorSum.2YearDelta[(n-2):n] <- dataframe$Up3OfCompositeTremorSum[n] - dataframe$Up3OfCompositeTremorSum[n-2]
                                dataframe$Up3OnCompositeTremorSum.2YearDelta[(n-2):n] <- dataframe$Up3OnCompositeTremorAmpSum[n] - dataframe$Up3OnCompositeTremorSum[n-2]
                                dataframe$Up3OfCompositeTremorSum.2YearROC[(n-2):n] <- elble.change(dataframe$Up3OfCompositeTremorSum[n-2], dataframe$Up3OfCompositeTremorSum[n], length(list.CompositeTremorOff), alpha = 0.5/length(list.CompositeTremorOff))
                                dataframe$Up3OnCompositeTremorSum.2YearROC[(n-2):n] <- elble.change(dataframe$Up3OnCompositeTremorSum[n-2], dataframe$Up3OnCompositeTremorSum[n], length(list.CompositeTremorrOn), alpha = 0.5/length(list.CompositeTremorOn))
                                ...
                                dataframe$Up3OfAppendicularSum.2YearDelta[(n-2):n] <- dataframe$Up3OfAppendicularSum[n] - dataframe$Up3OfAppendicularSum[n-2]
                                dataframe$Up3OnAppendicularSum.2YearDelta[(n-2):n] <- dataframe$Up3OnAppendicularSum[n] - dataframe$Up3OnAppendicularSum[n-2]
                                dataframe$Up3OfAppendicularSum.2YearROC[(n-2):n] <- elble.change(dataframe$Up3OfAppendicularSum[n-2], dataframe$Up3OfAppendicularSum[n], length(list.AppendicularOff), alpha = 0.5/length(list.AppendicularOff))
                                dataframe$Up3OnAppendicularSum.2YearROC[(n-2):n] <- elble.change(dataframe$Up3OnAppendicularSum[n-2], dataframe$Up3OnAppendicularSum[n], length(list.AppendicularOn), alpha = 0.5/length(list.AppendicularOn))
        ...
        df7 <- df6 %>%
                relocate(pseudonym, Timepoint, Gender, Age, EstDisDurYears, TimeToFUYears, MultipleSessions,
                         ...
                         Up3OfCompositeTremorSum, Up3OfCompositeTremorSum.1YearDelta, Up3OfCompositeTremorSum.1YearROC, Up3OfCompositeTremorSum.2YearDelta, Up3OfCompositeTremorSum.2YearROC,
                         Up3OnCompositeTremorSum, Up3OnCompositeTremorSum.1YearDelta, Up3OnCompositeTremorSum.1YearROC, Up3OnCompositeTremorSum.2YearDelta, Up3OnCompositeTremorSum.2YearROC,
                         ...
                         Up3OfAppendicularSum, Up3OfAppendicularSum.1YearDelta, Up3OfAppendicularSum.1YearROC, Up3OfAppendicularSum.2YearDelta, Up3OfAppendicularSum.2YearROC,
                         Up3OnAppendicularSum, Up3OnAppendicularSum.1YearDelta, Up3OnAppendicularSum.1YearROC, Up3OnAppendicularSum.2YearDelta, Up3OnAppendicularSum.2YearROC,
