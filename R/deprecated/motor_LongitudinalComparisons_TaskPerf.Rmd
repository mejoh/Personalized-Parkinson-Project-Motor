...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_lmer_T0.png',
          g_ba, dpi=300, device='png', base_width = 3.5)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_lmer_T2.png',
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_bradyprog_meanRTchange.png',
                  g, dpi=300, device='png', base_width = 5)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_bradyprog-3gt1change.png',
                  g, dpi=300, device='png', base_width = 5)

# Mean, baseline
m5 <- lm(AS.Mean.T0 ~ Up3BradySum.imp_T0 + Age + Gender + YearsSinceDiag + NpsEducYears + RespHandIsDominant, data = dfFMRI.c)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_BA-mean.png',
                  g, dpi=300, device='png', base_width = 5)
#Mean, follow-up
m6 <- lm(AS.Mean.T2 ~ Up3BradySum.imp_T2 + Age + Gender + YearsSinceDiag + NpsEducYears + RespHandIsDominant, data = dfFMRI.c)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_FU-mean.png',
                  g, dpi=300, device='png', base_width = 5)

# Multiple > Single, baseline
m11 <- lm(AS.23gt1.T0 ~ Up3BradySum.imp_T0 + Age + Gender + YearsSinceDiag + NpsEducYears + RespHandIsDominant, data = dfFMRI.c)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_BA-32gt1.png',
                  g, dpi=300, device='png', base_width = 5)
# Multiple > Single, follow-up
m12 <- lm(AS.23gt1.T2 ~ Up3BradySum.imp_T2 + Age + Gender + YearsSinceDiag + NpsEducYears + RespHandIsDominant, data = dfFMRI.c)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_FU-32gt1.png',
                  g, dpi=300, device='png', base_width = 5)
...
#         ylim(-0.6,0.6)
# print(g)
# save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ResponseTimes/RT_ClinProgCorrPlot.png',
#                   g, dpi=300, device='png', base_width = 5)
...
g <- ggarrange(g_ba,g_fu)
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ERR_lmer_T0.png',
          g_ba, dpi=300, device='png', base_width = 3.5)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ERR_lmer_T2.png',
          g_fu, dpi=300, device='png', base_width = 3.5)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ER_clinprog-meanchange.png',
                  g, dpi=300, device='png', base_width = 5)
...
g <- ggemmeans(m4, terms = 'Up3BradySum.imp_RawChange') %>% plot(add.data=TRUE,color='darkred') + theme_bw() + ggtitle('Clinical progression ~ Change in action selection (23-1)')
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ER_clinprog-23gt1.png',
                  g, dpi=300, device='png', base_width = 5)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ER_BA-mean.png',
                  g, dpi=300, device='png', base_width = 5)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ER_FU-mean.png',
                  g, dpi=300, device='png', base_width = 5)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ER_BA-23gt1.png',
                  g, dpi=300, device='png', base_width = 5)
...
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ER_FU-23gt1.png',
                  g, dpi=300, device='png', base_width = 5)
...
#         
# print(g)
# save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Accuracy/ER_ClinProgCorrPlot.png',
#                   g, dpi=300, device='png', base_width = 5)
...
#                   size = sigsize)
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Misc/Miss_lmer.png',
          g, dpi=300, device='png', base_width = 5)
...
# Group comparison
m.lmer <- tmp %>%
        lmer(Button.Press.CoV ~ ParticipantType*TimepointNr + Age + Gender + NpsEducYears + RespHandIsDominant + (1|pseudonym), data=.)
...
#                   size = sigsize)
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Misc/CoV_lmer.png',
          g, dpi=300, device='png', base_width = 5)
...
#                   size = sigsize)
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/Misc/Switch_lmer.png',
          g, dpi=300, device='png', base_width = 5)
...
g <- ggemmeans(m, terms='Up3OnBradySum_Td') %>% 
        ...
        ylim(-25,30)
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ClinicalProgression/ClinProg_OnOffCorr.png',
                  g, dpi=300, device='png', base_width = 5)
...
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/ClinicalProgression/ClinProg_lmer_Brady.png',
          g, dpi=300, device='png', base_width = 5)
...
g <- plot(pred, add.data = TRUE,color='darkred') + theme_bw() + ggtitle('') +
        ...
        geom_hline(yintercept = 0, color = 'darkgrey', lty = 2) + geom_vline(xintercept = 0, color = 'darkgrey', lty = 2)
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/FSL/randomise_severity_23gt1.png',
                  g, dpi=300, device='png', base_width = 5)
```
...
```{r sphere_rois, echo=FALSE, warning=TRUE, message=TRUE, eval=FALSE}
...
g <- ggarrange(g1,g2)
print(g)
save_plot('H:/sysneu/marjoh/Visualization/R_LongitudinalComparisonFmri/AFNI/ClustROI_Selection_vs_Bradykinesia.png',
