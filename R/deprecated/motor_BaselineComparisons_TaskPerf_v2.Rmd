...
compare_rts <- function(f, tmp, tmp.collapsed){
        ...
        contrast(em2, interaction = c('revpairwise','pairwise'), adjust='mvt', type='response', by=NULL) %>% print()
        emmip(fit, ParticipantType ~ trial_type, type='response') %>% print()
        
        em3 <- emmeans(fit, ~ trial_type|ParticipantType, type='response')
        contrast(em2, interaction = c('revpairwise','pairwise'), adjust='mvt', type='response') %>% print()
        emmip(fit, ParticipantType ~ trial_type, type='response') %>% print()
        ...
        em4 <- emmeans(fit, pairwise ~ ParticipantType, type='response', adjust='mvt')
        print(em4)
        emmip(fit, ~ ParticipantType, type='response', CIs=TRUE) %>% print()
        
        em5 <- emmeans(fit, revpairwise ~ trial_type, type='response', adjust='mvt')
        print(em5)
...
# f.me_null <- 'log(response_time) ~ 1 + block + Age_Dmean + Gender + NpsEducYears_Dmean + (1+trial_type|pseudonym)'
# fit.me_null <- lmer(f.me_null, data=tmp, control = lmerControl(optimizer = 'bobyqa', optCtrl=list(maxfun=2e5)), REML = FALSE)
# f.group <- 'log(response_time) ~ 1 + ParticipantType + block + Age_Dmean + Gender + NpsEducYears_Dmean + (1+trial_type|pseudonym)'
# fit.group <- lmer(f.group, data=tmp, control = lmerControl(optimizer = 'bobyqa', optCtrl=list(maxfun=2e5)), REML = FALSE)
# f.cond <- 'log(response_time) ~ 1 + trial_type + block + Age_Dmean + Gender + NpsEducYears_Dmean + (1+trial_type|pseudonym)'
# fit.cond <- lmer(f.cond, data=tmp, control = lmerControl(optimizer = 'bobyqa', optCtrl=list(maxfun=2e5)), REML = FALSE)
# anova(fit.me_null,fit.group) %>% print()
# anova(fit.me_null, fit.cond) %>% print()
# emmeans(fit.cond, pairwise ~ trial_type, type='response', adjust = 'bonferroni') %>% print()
# 
# f.int_null <- 'log(response_time) ~ 1 + ParticipantType+trial_type + block + Age_Dmean + Gender + NpsEducYears_Dmean + (1+trial_type|pseudonym)'
# fit.int_null <- lmer(f.int_null, data=tmp, control = lmerControl(optimizer = 'bobyqa', optCtrl=list(maxfun=2e5)), REML = FALSE)
# f.int <-'log(response_time) ~ 1 + ParticipantType*trial_type + block + Age_Dmean + Gender + NpsEducYears_Dmean + (1+trial_type|pseudonym)'
# fit.int <- lmer(f.int, data=tmp, control = lmerControl(optimizer = 'bobyqa', optCtrl=list(maxfun=2e5)), REML = FALSE)
# anova(fit.int_null, fit.int) %>% print()
# emmeans(fit.int, ~ParticipantType|trial_type) %>% contrast(interaction = c('pairwise','pairwise'), by = NULL, type = 'response', adjust = 'bonferroni')
...
compare_rts_for_medication <- function(f, tmp, tmp.collapsed){
        ...
        em3 <- emmeans(fit, ~ trial_type|ParticipantType, type='response')
        contrast(em3, interaction = c('pairwise','pairwise'), adjust='mvt', type='response') %>% print()
        emmip(fit, ParticipantType ~ trial_type, type='response') %>% print()
        ...
        em5 <- emmeans(fit, pairwise ~ trial_type, type='response', adjust='mvt')
        print(em5)
        emmip(fit, ~ trial_type, type='response', CIs=TRUE) %>% print()
...
compare_rts_for_subtypes <- function(f, tmp, tmp.collapsed){
        ...
        em2 <- emmeans(fit, ~ trial_type|ParticipantType, type='response')
        contrast(em2, interaction = c('pairwise','pairwise'), adjust='mvt', type='response') %>% print()
        emmip(fit, ParticipantType ~ trial_type, type='response') %>% print()
        ...
        em4 <- emmeans(fit, pairwise ~ ParticipantType, adjust='mvt', type='response')
        print(em4)
        emmip(fit, ~ ParticipantType, type='response', CIs=TRUE) %>% print()
...
compare_correct <- function(f, tmp, tmp.collapsed){
        ...
        contrast(em4, interaction = c('revpairwise','pairwise'), adjust='mvt', type='response') %>% print()
        emmip(fit, ParticipantType ~ trial_type, type='response') %>% print()
...
compare_correct_for_subtypes <- function(f, tmp, tmp.collapsed){
        ...
        em4 <- emmeans(fit, ~ ParticipantType, type='response')
        contrast(em4, interaction = c('pairwise','pairwise'), adjust='mvt', type='response', by=NULL) %>% print()
        emmip(fit, ~ParticipantType, type='response') %>% print()
        cat('\n \n')
...
f <- 'incorrect_response_fct ~ 1 + ParticipantType*trial_type + block + Age_Dmean + Gender + (1|pseudonym)'
