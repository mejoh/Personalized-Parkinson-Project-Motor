...
plot <-raincloudplot_1Factor(fmridat, 'Beta', c('Group'), title = 'Average task-related activity in \nthe most affected putamen',
        ...
        geom_segment(aes(x=1,xend=2,y=2.5,yend=2.5), size=lsize) + 
        geom_text(x=1.5, y=2.6, label='***', size=sigsize) +
        geom_segment(aes(x=1,xend=1,y=2.5,yend=2.4),size=lsize) + 
        geom_segment(aes(x=2,xend=2,y=2.5,yend=2.4),size=lsize)
print(plot)
save_plot('H:/sysneu/marjoh/Visualization/R_BaselineComparisonFmri/Brain_HCvsON_HCgtON_Mean_Putamen1.tiff',
          plot, dpi=320, device='tiff', base_height = 12, base_asp = 2)
#####
...
plot <- raincloudplot_2Factor(fmridat, 'Beta', c('Cond','Group'), 
                              ...
                              xticklabs = c(paste('HC', ' (n=', N[1],')', sep=''),
                                            paste('PD-On', ' (n=', N[2],')', sep='')),
                              legend_title = '',
                              legend_position = c(0.85,1.25), legend_labels = c('One','Two','Three'),
                              color_scheme = 'mako') + 
        ylim(-6,6) +
        geom_segment(aes(x=1,xend=2,y=5,yend=5), size=lsize) + 
        geom_text(x=1.5, y=5.2, label='***', size=sigsize) +
        geom_segment(aes(x=1,xend=1,y=5,yend=4.7), size=lsize) + 
        geom_segment(aes(x=2,xend=2,y=5,yend=4.7), size=lsize) +
        geom_segment(aes(x=0.8,xend=1.2,y=4.7,yend=4.7), size=lsize) + 
        geom_segment(aes(x=1.8,xend=2.2,y=4.7,yend=4.7), size=lsize) +
        geom_segment(aes(x=0.8,xend=0.8,y=4.7,yend=4.4),size=lsize) +
        geom_segment(aes(x=1.2,xend=1.2,y=4.7,yend=4.4),size=lsize) +
        geom_segment(aes(x=1.8,xend=1.8,y=4.7,yend=4.4),size=lsize) +
        geom_segment(aes(x=2.2,xend=2.2,y=4.7,yend=4.4),size=lsize)
print(plot)
...
#           plot, dpi=320, device='tiff', base_height = 12, base_asp = 1.2)
...
plot <- raincloudplot_2Factor(fmridat, 'Beta', c('Cond','Group'),
                      ...
                      color_scheme = 'mako') +
        ylim(-6,11) +
        geom_segment(x=1,xend=2,y=11,yend=11,size=lsize) +
        geom_segment(x=1,xend=1,y=11,yend=10.7,size=lsize) +
        geom_segment(x=2,xend=2,y=11,yend=10.7,size=lsize) +
        geom_segment(x=0.8,xend=1.2,y=10.7,yend=10.7,size=lsize) +
        geom_segment(x=1.8,xend=2.2,y=10.7,yend=10.7,size=lsize) +
        geom_segment(x=0.8,xend=0.8,y=10.7,yend=10.5,size=lsize) +
        geom_segment(x=1.2,xend=1.2,y=10.7,yend=10.5,size=lsize) +
        geom_segment(x=1.8,xend=1.8,y=10.7,yend=10.5,size=lsize) +
        geom_segment(x=2.2,xend=2.2,y=10.7,yend=10.5,size=lsize) +
        geom_text(x=1.5,y=11.2,label='***',size=sigsize,show.legend = FALSE) +
        
        geom_segment(x=1,xend=3,y=9,yend=9,size=lsize) +
        geom_segment(x=1,xend=1,y=9,yend=8.7,size=lsize) +
        geom_segment(x=3,xend=3,y=9,yend=8.7,size=lsize) +
        geom_segment(x=0.8,xend=1.2,y=8.7,yend=8.7,size=lsize) +
        geom_segment(x=2.8,xend=3.2,y=8.7,yend=8.7,size=lsize) +
        geom_segment(x=0.8,xend=0.8,y=8.7,yend=8.5,size=lsize) +
        geom_segment(x=1.2,xend=1.2,y=8.7,yend=8.5,size=lsize) +
        geom_segment(x=2.8,xend=2.8,y=8.7,yend=8.5,size=lsize) +
        geom_segment(x=3.2,xend=3.2,y=8.7,yend=8.5,size=lsize) +
        geom_text(x=2,y=9.2,label='***',size=sigsize,show.legend = FALSE)
print(plot)
save_plot('H:/sysneu/marjoh/Visualization/R_BaselineComparisonFmri/Brain_ImputedSubtypes_MMPgtDM&MMPgtIM_INT3gtEXT_PMC.tiff',
          plot, dpi=320, device='tiff', base_height = 12, base_asp = 2)
...
plot <- raincloudplot_2Factor(fmridat, 'Beta', c('Cond','Group'),
                      ...
                      color_scheme = 'mako') +
        ylim(-5,6) +
        geom_segment(x=1,xend=2,y=6,yend=6,size=lsize) +
        geom_segment(x=1,xend=1,y=6,yend=5.7,size=lsize) +
        geom_segment(x=2,xend=2,y=6,yend=5.7,size=lsize) +
        geom_segment(x=0.8,xend=1.2,y=5.7,yend=5.7,size=lsize) +
        geom_segment(x=1.8,xend=2.2,y=5.7,yend=5.7,size=lsize) +
        geom_segment(x=0.8,xend=0.8,y=5.7,yend=5.5,size=lsize) +
        geom_segment(x=1.2,xend=1.2,y=5.7,yend=5.5,size=lsize) +
        geom_segment(x=1.8,xend=1.8,y=5.7,yend=5.5,size=lsize) +
        geom_segment(x=2.2,xend=2.2,y=5.7,yend=5.5,size=lsize) +
        geom_text(x=1.5,y=6.2,label='***',size=sigsize,show.legend = FALSE)
print(plot)
...
plot <- raincloudplot_2Factor(fmridat, 'Beta', c('Cond','Group'),
                      ...
                      color_scheme = 'mako') +
        ylim(-6,8) +
        geom_segment(x=1,xend=4,y=8,yend=8,size=lsize) +
        geom_segment(x=1,xend=1,y=8,yend=7.7,size=lsize) +
        geom_segment(x=4,xend=4,y=8,yend=7.7,size=lsize) +
        geom_segment(x=0.8,xend=1.2,y=7.7,yend=7.7,size=lsize) +
        geom_segment(x=3.8,xend=4.2,y=7.7,yend=7.7,size=lsize) +
        geom_segment(x=0.8,xend=0.8,y=7.7,yend=7.5,size=lsize) +
        geom_segment(x=1.2,xend=1.2,y=7.7,yend=7.5,size=lsize) +
        geom_segment(x=3.8,xend=3.8,y=7.7,yend=7.5,size=lsize) +
        geom_segment(x=4.2,xend=4.2,y=7.7,yend=7.5,size=lsize) +
        geom_text(x=2.5,y=8.2,label='***',size=sigsize,show.legend = FALSE)
print(plot)
...
compare_rts <- function(f, tmp, tmp.collapsed){
        ...
        plot <- raincloudplot_2Factor(data=tmp.collapsed, y='response_time',
                ...
                ylim(0.3,1.75) +
                geom_text(x=1.5,y=1.62,label='**',size=sigsize) +
                geom_segment(x=1,xend=2,y=1.6,yend=1.6,size=lsize) +
                geom_segment(x=1,xend=1,y=1.6,yend=1.57,size=lsize) +
                geom_segment(x=2,xend=2,y=1.6,yend=1.57,size=lsize) +
                geom_segment(x=0.8,xend=1.2,y=1.57,yend=1.57,size=lsize) +
                geom_segment(x=1.8,xend=2.2,y=1.57,yend=1.57,size=lsize) #+
                # geom_segment(x=0.8,xend=0.8,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=1.2,xend=1.2,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=1.8,xend=1.8,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=2.2,xend=2.2,y=1.58,yend=1.56,size=lsize) +
                # geom_text(x=0.9,y=1.52,label='***',size=sigsize) +
                # geom_segment(x=0.8,xend=1,y=1.50,yend=1.50,size=lsize) +
                # geom_text(x=1.9,y=1.52,label='***',size=sigsize) +
                # geom_segment(x=1.8,xend=2,y=1.50,yend=1.50,size=lsize) +
                # geom_text(x=1,y=1.44,label='***',size=sigsize) +
                # geom_segment(x=0.8,xend=1.2,y=1.42,yend=1.42,size=lsize) +
                # geom_text(x=2,y=1.44,label='***',size=sigsize) +
                # geom_segment(x=1.8,xend=2.2,y=1.42,yend=1.42,size=lsize)
        print(plot)
...
plot <- ggplot(plotdat, aes(y=response_time, x=Up3OfAppendicularSum)) +
        ...
        geom_smooth(method='lm', se = FALSE, lwd = 2, color = 'black') +
        ggtitle('Association between response times and \ndisease severity') + 
        xlab('MDS-UPDRS III (bradykineisa + rigidity)') +
        ylab('Average response time (s)') +
        theme_cowplot(font_size = 70, font_family = 'Calibri') +
        geom_text(x=50,y=1.5, label = paste('N=', N, ', r=', round(c$estimate,digits=2), sep=''),
                  size=16) +
        ylim(0.5,1.5) + xlim(0,60)
print(plot)
...
compare_rts_for_subtypes <- function(f, tmp, tmp.collapsed){
        ...
        plot <- raincloudplot_2Factor(data=tmp.collapsed, y='response_time',
                                      ...
                                      provided_summary = 'None') +
                ylim(0.3,1.75) #+
                # geom_text(x=2,y=1.62,label='***',size=sigsize,show.legend=FALSE) +
                # geom_segment(x=1,xend=3,y=1.6,yend=1.6,size=lsize) +
                # geom_segment(x=1,xend=1,y=1.6,yend=1.58,size=lsize) +
                # geom_segment(x=2,xend=2,y=1.6,yend=1.58,size=lsize) +
                # geom_segment(x=3,xend=3,y=1.6,yend=1.58,size=lsize) +
                # geom_segment(x=0.8,xend=1.2,y=1.58,yend=1.58,size=lsize) +
                # geom_segment(x=1.8,xend=2.2,y=1.58,yend=1.58,size=lsize) +
                # geom_segment(x=2.8,xend=3.2,y=1.58,yend=1.58,size=lsize) +
                # geom_segment(x=0.8,xend=0.8,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=1.8,xend=1.8,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=2.8,xend=2.8,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=1.2,xend=1.2,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=2.2,xend=2.2,y=1.58,yend=1.56,size=lsize) +
                # geom_segment(x=3.2,xend=3.2,y=1.58,yend=1.56,size=lsize) +
                # geom_text(x=0.9,y=1.53,label='***',size=sigsize,show.legend=FALSE) +
                # geom_segment(x=0.8,xend=1,y=1.52,yend=1.52,size=lsize) +
                # geom_text(x=1,y=1.49,label='***',size=sigsize,show.legend=FALSE) +
                # geom_segment(x=0.8,xend=1.2,y=1.48,yend=1.48,size=lsize) +
                # geom_text(x=1.9,y=1.53,label='***',size=sigsize,show.legend=FALSE) +
                # geom_segment(x=1.8,xend=2,y=1.52,yend=1.52,size=lsize) +
                # geom_text(x=2,y=1.49,label='***',size=sigsize,show.legend=FALSE) +
                # geom_segment(x=1.8,xend=2.2,y=1.48,yend=1.48,size=lsize) +
                # geom_text(x=2.9,y=1.53,label='*',size=sigsize,show.legend=FALSE) +
                # geom_segment(x=2.8,xend=3,y=1.52,yend=1.52,size=lsize) +
                # geom_text(x=3,y=1.5,label='+',size=sigsize-4,show.legend=FALSE) +
                # geom_segment(x=2.8,xend=3.2,y=1.48,yend=1.48,size=lsize)
        print(plot)
...
compare_correct <- function(f, tmp){
        ...
        save_plot('H:/sysneu/marjoh/Visualization/R_BaselineComparisonFmri/Accuracy_HCvsON.tiff',
                  tplot, dpi=320, device='tiff', base_height = 12, base_asp = 2)
...
```{r echo=FALSE, message=FALSE, warning=TRUE}
compare_correct_for_medication <- function(f, tmp){
        # Fit model
        print(paste('Fitting the following model:', f, sep=' '))
        fit <- glmer(f, data=tmp, family = binomial,
                     control = glmerControl(optimizer = 'bobyqa', optCtrl=list(maxfun=2e5)))
