...
f <- 'log1p(Mean) ~ Up3OfTotal.1YearDelta + Gender + scale(Age, center=TRUE, scale=FALSE)'
print(paste('Fitting the following model:', f, sep=' '))
...
f <- 'log1p(Mean) ~ Group*Up3OfTotal.1YearDelta + Gender + scale(Age, center=TRUE, scale=FALSE)'
print(paste('Fitting the following model:', f, sep=' '))
infer_SUBS_ProgTotalRTs_mean <- lm(f, data=data_SUBS_ProgTotalRTs_mean)
interrogate_mod(infer_SUBS_ProgTotalRTs_mean)
...
f <- 'log1p(Response.Time) ~ Group*Condition*Up3OfTotal.1YearDelta + Gender + scale(Age, center=TRUE, scale=FALSE) + (1|pseudonym)'
print(paste('Fitting the following model:', f, sep=' '))
