...
datafile_clin_pom <- 'P:/3022026.01/pep/ClinVars4/derivatives/merged_manipulated_2021-11-29.csv'
...
data_clin_pom_orig <- data_clin_pom
...
data_clin <- data_clin_pom_orig %>%
        ...
        select(pseudonym, Timepoint, TimepointNr, Age, Gender, Subtype_DisDurSplit, MonthSinceDiag, WeeksToFollowUp,
...
data_SUBS <- full_join(data_clin, data_task, by = c('pseudonym', 'Timepoint')) %>%
        mutate(Group = Subtype_DisDurSplit,
